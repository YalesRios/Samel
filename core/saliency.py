...
def get_ensemble_optimisers(ensemble):
    optimisers = []
...
def generate_saliency_maps_for_one_input(ensemble,input,optimisers,visualised_layer):
...
def calculate_uncertainty_for_one_input(ensemble,input,optimisers,visualised_layer):
...
def calculate_uncertainties_for_multiple_inputs(ensemble,inputs,output_nodes,optimisers,visualised_layer):
